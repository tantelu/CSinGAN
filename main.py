...
parser.add_argument('--img_size_max', default=266, type=int, help='Input image size')
...
parser.add_argument('--validation',default=0, dest='validation', action='store_true',
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.validation:
        networks[1].current_scale-=1
        validateSinGAN(train_loader, networks, args.stage-1, args, {"z_rec": z_fix_list})
        return
